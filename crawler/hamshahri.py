...
def get_hamshahri():
    ...
    # -----------------------Culture-----------------------
    for i in range(1,10):
        link = f'https://www.hamshahrionline.ir/page/archive.xhtml?wide=0&ms=0&pi={i}&tp=5'
        driver.get(link)
    ...
    #-----------------------Politics-----------------------
    for i in range(1,10):
        link = f'https://www.hamshahrionline.ir/page/archive.xhtml?wide=0&ms=0&pi={i}&tp=6'
        driver.get(link)
        urls_div = driver.find_element(By.CLASS_NAME, 'col-12.col-sm-9')
        all_links = urls_div.find_elements(By.TAG_NAME, 'a')
        list_of_sub_link = set(list_of_sub_link)
    ...
    #-----------------------Sport-----------------------
    for i in range(1,10):
        link = f'https://www.hamshahrionline.ir/page/archive.xhtml?wide=0&ms=0&pi={i}&tp=9'
        driver.get(link)
        urls_div = driver.find_element(By.CLASS_NAME, 'col-12.col-sm-9')
        all_links = urls_div.find_elements(By.TAG_NAME, 'a')
        list_of_sub_link = set(list_of_sub_link)
    ...
    #-----------------------Economy-----------------------
    for i in range(1,10):
        link = f'https://www.hamshahrionline.ir/page/archive.xhtml?wide=0&ms=0&pi={i}&tp=10'
        driver.get(link)
        urls_div = driver.find_element(By.CLASS_NAME, 'col-12.col-sm-9')
        all_links = urls_div.find_elements(By.TAG_NAME, 'a')
        list_of_sub_link = set(list_of_sub_link)
